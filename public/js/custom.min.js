  ...
  return {
    init: function () {
      ...
      n(),
        ...
        ((l = window.outerHeight) > 0 ? l : screen.height) &&
          $(".content-body").css("min-height", l - 140 + "px"),
    ...
    handleMenuPosition: function () {
      e > 1024 &&
        $(".metismenu  li")
          ...
          .each(function (e) {
            if ($("ul", this).length > 0) {
              var t = (l = $("ul:first", this).css("display", "block")).offset()
                  .left,
                n = l.width(),
                l = $("ul:first", this).removeAttr("style"),
...
jQuery(document).ready(function () {
  $('[data-toggle="popover"]').popover(), KMS.init();
}),
  jQuery(window).on("load", function () {
    "use strict";
    KMS.load(),
      setTimeout(function () {
        KMS.handleMenuPosition();
      }, 1e3);
  }),
